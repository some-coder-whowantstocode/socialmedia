    ...
    <div>
      <div className="flex items-center justify-center h-full w-full flex-col">
        <div className="flex bg-gray p-10 items-center justify-center border  border-gray-400 flex-col w-logbox h-logbox mt-3">
          <img
            className="h-24"
            src="https://th.bing.com/th/id/OIP.rLmz6Nq4KnvPUb34z_SuGgHaHa?pid=ImgDet&rs=1"
          />
          <div className="flex items-center justify-center text-l my-2 font-bold">
            Trouble logging in?
          </div>
          <div className="flex items-center justify-center text-sm text-gray-400">
            Enter your email and username and we'll send you a link to get back
            into your account.
          </div>
          <div>
            <p>user name</p>
            <input
              onChange={handlename}
              type="email"
              className="border h-ibox w-ibox focus:bg-gray-200 focus:outline-none border-black"
            />
            <p>Email</p>
            <input
          ...
          <NavLink className={" font-semibold hover:text-black"} to={"/signup"}>
            Create new account
          </NavLink>
        </div>
